          ...
          <SheetHeader className="px-5 pb-4 border-b border-border">
            ...
            <div className="flex gap-2 pt-2">
              <Button
                ...
                className={`flex-1 h-10 rounded-xl ${status === "done" ? "bg-primary hover:bg-primary/90" : "border-border"}`}
              >
                Done
              </Button>
              <Button
                ...
                className={`flex-1 h-10 rounded-xl ${status === "open" ? "bg-primary hover:bg-primary/90" : "border-border"}`}
              >
                Open
              </Button>
              <Button
          ...
          <div className="border-t border-border p-4 bg-card" style={{ paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
            <div className="flex gap-3">
              ...
              <Button
                ...
                className="flex-1 h-12 rounded-2xl bg-primary hover:bg-primary/90 text-base"
