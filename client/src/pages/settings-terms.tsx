      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">1. Master Service Agreement</CardTitle>
          </CardHeader>
        ...
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">2. Acceptable Use Policy</CardTitle>
          </CardHeader>
          <CardContent className="text-foreground p-6 space-y-4">
        ...
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">3. Intellectual Property and Content Rights</CardTitle>
          </CardHeader>
          <CardContent className="text-foreground p-6 space-y-4">
            <p>
              <strong className="text-foreground">Your Content:</strong> You retain all ownership rights to the meeting notes, transcriptions, and entries you provide. You grant ActionMinutes a non-exclusive, world-wide, royalty-free license to host, copy, and display your content solely as necessary to provide the service to you.
            </p>
            <p>
              <strong className="text-foreground">Our Platform:</strong> ActionMinutes and its original content (excluding user content), features, and functionality are and will remain the exclusive property of ActionMinutes and its licensors.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">4. AI Reliability and Disclaimer</CardTitle>
          </CardHeader>
          <CardContent className="text-foreground p-6 space-y-4">
            <p>
            ...
            <p className="italic bg-accent p-3 rounded-lg border-l-4 border-primary text-foreground">
        ...
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">5. Limitation of Liability and Indemnification</CardTitle>
          </CardHeader>
          <CardContent className="text-foreground p-6 space-y-4">
            <p>
        ...
        <Card className="bg-muted border-border rounded-xl overflow-hidden">
          <CardHeader className="bg-muted border-b border-border">
            <CardTitle className="text-lg text-foreground">6. Termination and Suspension</CardTitle>
          </CardHeader>
          <CardContent className="text-foreground p-6 space-y-4">
            <p>
