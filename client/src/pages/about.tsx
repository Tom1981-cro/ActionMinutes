...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white" data-testid="page-about">
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-violet-600/10 rounded-full blur-[150px] -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-fuchsia-500/10 rounded-full blur-[120px] translate-x-1/3 translate-y-1/3" />
      </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-16 space-y-16">
            ...
            <CardContent className="p-8 md:p-10 space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500">
                  <Heart className="h-6 w-6 text-white" weight="fill" />
                </div>
              ...
              <div className="space-y-4 text-white/70 leading-relaxed">
                ...
                <p>
                  Unlike team-focused tools that add complexity, ActionMinutes is designed for <strong className="text-white">you</strong>. 
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <motion.div
            ...
            custom={2}
          >
            <Card className="h-full bg-white/5 border-white/10 rounded-2xl overflow-hidden">
              <CardContent className="p-6 space-y-4">
                <div className="p-2.5 w-fit rounded-xl bg-violet-500/20">
                  <Lightning className="h-5 w-5 text-violet-400" weight="duotone" />
                </div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/login"
              className="group relative inline-flex items-center gap-2 text-white px-8 py-3 rounded-xl font-semibold transition-all"
            >
              <span className="absolute inset-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 rounded-xl" />
              <span className="absolute inset-0 bg-gradient-to-r from-violet-500 to-fuchsia-500 rounded-xl blur-lg opacity-50 group-hover:opacity-75 transition-opacity" />
