      ...
      <div className="container max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 items-start">
          ...
          >
            ...
            <p className="text-white/50 text-sm mb-6">Perfect for trying it out.</p>
            ...
            <Link
              href="/login"
              className="block w-full text-center bg-white/10 hover:bg-white/15 border border-white/10 text-white py-3 rounded-xl font-semibold transition-all"
          ...
          >
            ...
            <p className="text-white/50 text-sm mb-6">For serious productivity.</p>
          ...
          >
            ...
            <p className="text-white/50 text-sm mb-6">Collaborate with your crew.</p>
            
            <div className="mb-6">
              <span className="text-4xl font-bold">
                ${isYearly ? prices.team.yearly : prices.team.monthly}
              </span>
              <span className="text-white/40 ml-2">/month</span>
              {isYearly && (
                <span className="block text-sm text-emerald-400 mt-1">
